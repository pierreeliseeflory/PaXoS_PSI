...
// https://github.com/cryptobiu/libscapi/blob/master/src/cryptoInfra/Protocol.cpp
ProtocolParty::ProtocolParty(int argc, char *argv[]) : Protocol("PSI", argc, argv)
{
    ...
    // libscapi configfile
    // https://github.com/cryptobiu/libscapi/blob/master/src/infra/ConfigFile.cpp
    // model :
    // key = value
    // ex : party_0_port = 8080
